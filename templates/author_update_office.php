...
<form enctype="multipart/form-data" method="post" action="/update/<?= $recipe['id'] ?>" id="feedback-form">
<label for="nameFF">название:</label>
<input type="text" name="title" value="<?= $recipe['title'] ?>" class="w100 border">

<label for="messageFF">Сообщение:</label>
<textarea name="recipe"  required rows="5" placeholder="Детали заявки…" class="w100 border"><?= $recipe['recipe'] ?></textarea></br>
<img src = "/uploads/<?= $recipe['image'] ?>" width = 100 /><br><br><br>
<br>
